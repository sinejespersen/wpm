...
function getSentence() {
  if (proverbs.length > 0) {
    currentString = __WEBPACK_IMPORTED_MODULE_0_underscore___default.a.sample(proverbs);
    proverbs = __WEBPACK_IMPORTED_MODULE_0_underscore___default.a.without(proverbs, currentString);
...
function commenceDoneProcedure(result) {
  ...
  finishedString += `
    [skrevet: ${result}, rettet: ${stringFromInput}, forventet: ${currentString}, tid: ${Math.round(howLongTyped)}, corrected text: ${areThereSpecialCharacters}] <br>`;
